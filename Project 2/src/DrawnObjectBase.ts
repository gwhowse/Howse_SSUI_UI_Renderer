   ...
   //-------------------------------------------------------------------
    ...
    public set x(v : number) {
        if (v !== this.x) {
            ...
            //=== YOUR CODE HERE === 
            // Declare damage with the bounding box at our old value
            this.damageAll();

            // Then change to our new value and declare damage again
            this._x = v;
            this.damageAll();
        }
    }    
    ...
    public set w(v : number) {
        //=== YOUR CODE HERE === 
        // Make sure is valid within our size config
    ...
    public set h(v : number) {
        //=== YOUR CODE HERE ===
        // Make sure our v is valid within our size configuration
    ...
    public set hConfig(v : SizeConfigLiteral) {
        //=== YOUR CODE HERE ===
        if (!(SizeConfig.eq(this.hConfig, v))) {
            // Declare damage with the bounding box at our old value
            this.damageAll();
    ...
    {
        //=== YOUR CODE HERE ===
        // Make our clipping rectangle and then clip it
        ctx.beginPath();
    ...
    protected _startChildDraw(childIndx : number, ctx: DrawContext) {
        ...
        //=== YOUR CODE HERE ===
        // Move so that our canvas x,y match child x,y then clip to child width and height
    ...
    public damageArea(xv: number, yv : number, wv : number, hv : number) : void {
        //=== YOUR CODE HERE ===
        // if we have a parent, pass the damage up. if we don't, this will be overridden in top object
    ...
    {
            //=== YOUR CODE HERE ===
        // translate our child coords and then declare damage
        let xLocal = xInChildCoords + child.x;
        let yLocal = yInChildCoords + child.y;
